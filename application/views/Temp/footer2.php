         ...
         $.ajax({
             ...
             success: function(x) {
                 if (x.status == true) {
                     ...
                     $('#nomor_lc').val(x.data.nomor_lc);
                     $('#file_upload').text(x.data.file_upload);
 ...
 <script src="https://code.responsivevoice.org/responsivevoice.js?key=iXQPs9ug"></script>
 <script>
     (function(d) {
         var s = d.createElement("script");
         s.setAttribute("data-account", "wp8DTqJcZb");
